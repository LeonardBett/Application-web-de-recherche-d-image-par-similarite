  ...
  public class RedirectConfiguration {
      ...
      private OncePerRequestFilter createRedirectFilter() {
          return new OncePerRequestFilter() {
              // Forwards all routes except '/index.html', '/200.html', '/favicon.ico', '/sw.js' '/images/', '/images/**'
              private final String REGEX = "(?!/actuator|/images|/_nuxt|/static|/index\\.html|/200\\.html|/favicon\\.ico|/sw\\.js).*$";
