...
// Au début, nous avions mis cette page à l'adresse /QuizzImage/0, mais il y avait un problème : quand nous choisissions un niveau, l'image ne s'affichait jamais.
</script>
<template>
  <div>
